    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={[styles.title, styles.darkBlue]}>Register</Text>
                ...
                <View style={styles.inputView}>
                    <Text style={[styles.textSmall, styles.darkBlue]}>Email</Text>
                    <TextInput 
                        style={styles.inputText}
                ...
                <View style={styles.inputView}>
                    <Text style={[styles.textSmall, styles.darkBlue]}>Ulangi Password</Text>
                    <TextInput 
                        style={styles.inputText}
                        onChangeText={text => this.setState({konfirmasi:text})}/>
                </View>
